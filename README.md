...
*   **Co-op Mode:** (In Development) A planned feature to allow players to team up, combining physical AI gestures and traditional keyboard controls to manage the chaotic falling blocks together!
...
NeonLink features two distinct architectures:
...
### 🖥️ Running the Python Desktop Version
